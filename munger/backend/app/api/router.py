...
from app.api import sources, wiki, entities, search, munger, config as config_api, retrieval, resolution, communities, chat, feedback, graph, gc, pipeline
...
api_router.include_router(gc.router, prefix="/gc", tags=["gc"])
